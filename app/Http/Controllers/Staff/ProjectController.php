...
class ProjectController extends Controller
{
    ...
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.common.index', compact('projects'));
    }

    public function returnIndex()
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.unqualified.index', compact('projects'));
    }

     public function forfietedIndex()
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.forfitted.index', compact('projects'));
    }
    ...
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.pgreturn.index', compact('projects'));
    }

     public function securityreturnIndex()
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.security_deposits.index', compact('projects'));
    }
     ...
     public function withheldreturnIndex()
    {
        ...
        return view('staff.withheld.index', compact('projects'));
    }
    ...
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.pgforfitted.index', compact('projects'));
    }

     public function securityforfietedIndex()
    {
        $projects = Project::with(['departments', 'state','emds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.securitydeposite_forfieted.index', compact('projects'));
    }
    ...
    {
        $projects = Project::with(['departments', 'state','withhelds'])->where('user_id', auth()->id())->latest()->paginate(20);
        return view('staff.withheld_forfieted.index', compact('projects'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.projects.create', compact('departments','states'));
    }
     ...
     public function commonCreate(Project $project)
        {
            ...
            return view('staff.common.indexdetails', compact('project', 'emdDetails', 'pgDetails', 'securityDeposits', 'withhelds'));
        }
        ...
        public function returnedCreate(Project $project)
        {
            ...
            return view('staff.unqualified.indexdetails', compact('project', 'emdDetails', 'forfieteds', 'returneds', 'actives'));
        }
          ...
          public function pgreturnedCreate(Project $project)
        {
            ...
            return view('staff.pgreturn.indexdetails', compact('project', 'pgDetails', 'forfieteds', 'returneds', 'actives'));
        }
          ...
          public function securityreturnedCreate(Project $project)
        {
            ...
            return view('staff.security_deposits.indexdetails', compact('project', 'securityDeposits', 'forfieteds', 'returneds', 'actives'));
        }
           ...
           public function withheldreturnedCreate(Project $project)
        {
            ...
            return view('staff.withheld.index2', compact('project', 'withhelds', 'forfieteds', 'returneds', 'actives'));
        }
    ...
    {
        $emdDetails = $project->emds;
        return view('staff.forfitted.index2', compact('project', 'emdDetails'));
    }
    ...
    public function pgforfietedCreate(Project $project)
    {
        ...
        return view('staff.pgforfitted.index2', compact('project', 'pgDetails'));
    }
    ...
    public function securityforfietedCreate(Project $project)
    {
        ...
        return view('staff.securitydeposite_forfieted.index2', compact('project', 'securityDeposits'));
    }
    ...
    public function withheldforfietedCreate(Project $project)
    {
        ...
        return view('staff.withheld_forfieted.index2', compact('project', 'withhelds'));
    }
   ...
   public function store(ProjectRequest $request)
    ...
    public function acceptanceIndex()
    {
        ...
        return view('staff.acceptance.index', compact('projects'));
    }
     ...
     public function awardIndex()
    {
        ...
        return view('staff.award.index', compact('projects'));
    }
      ...
      public function agreementIndex()
    {
        ...
        return view('staff.agreement.index', compact('projects'));
    }
    ...
    {
        return view('staff.projects.createagreementdate', compact('project'));
    }
   ...
   public function updateDocAndStatus4(Request $request, Project $project)
    ...
    public function edit(Project $project)
    {
        $states = State::orderBy('name')->get();
        $departments = Department::where('user_id', auth()->id())->orderBy('name')->get();
        return view('staff.projects.edit', compact('project', 'states', 'departments'));
    }
    ...
    {
        $project->delete();
        return redirect()->route('staff.projects.index')->with('success','Deleted.');
    }
}
