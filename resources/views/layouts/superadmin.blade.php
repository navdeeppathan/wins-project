           ...
           <div class="nav-item">
            ...
            <div class="nav-item">
                ...
                class="nav-link {{ Request::is('superadmin/subscriptions*') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">Plan Subscriptions</span>
                    @php
                        $pendingSubsCount = class_exists(\App\Models\Subscription::class) && \Illuminate\Support\Facades\Schema::hasTable('subscriptions')
                            ? \App\Models\Subscription::where('payment_status', 'pending')->count()
                            : 0;
                    @endphp
                    @if($pendingSubsCount > 0)
                        <span class="badge bg-warning text-dark ms-auto" style="font-size: 0.72rem;">{{ $pendingSubsCount }}</span>
                    @endif
                </a>
            </div>
            <div class="nav-item">
                <a href="{{ route('superadmin.plans.index') }}"
                class="nav-link {{ Request::is('superadmin/plans*') ? 'active' : '' }}">
                    <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="nav-item">
                ...
                class="nav-link {{ Request::is('admin/cqc-vault*') ? 'active' : '' }}">
                    <span class="nav-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        </svg>
                    </span>
                    <span class="nav-text">E-Vault</span>
                </a>
            </div>
