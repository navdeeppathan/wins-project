        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                ...
                <div class="sidebar-dropdown">
                    <a href="{{ route('staff.projects.returned.index') }}" class="dropdown-item nav-link {{ Request::is('staff/emd*') ? 'active' : '' }}">EMD</a>
            ...
            <div class="nav-item">
                ...
                <div class="sidebar-dropdown">
                    <a href="{{ route('staff.departments.index') }}" class="dropdown-item {{ Request::is('staff/departments*') ? 'active' : '' }}">DEPARTMENTS</a>
                    <a href="{{ route('staff.vendors.index') }}" class="dropdown-item {{ Request::is('staff/vendors*') ? 'active' : '' }}">VENDORS</a>
                    {{-- <a href="{{ route('staff.users.index') }}"class="dropdown-item {{ Request::is('staff/users*') ? 'active' : '' }}">STAFF</a> --}}
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="sidebar-dropdown">
                    {{-- <a href="" class="dropdown-item nav-link {{ Request::is('staff/emd*') ? 'active' : '' }}">ESTIMATION</a> --}}
    ...
    <div class="main-wrapper">
        <header class="topbar">
            ...
            <div>
                    ...
                    <span style="color: red;" class="topbar-title text-center text-red">YOUR P.O.V. TRIAL PERIOD IS VALID UPTO 31/07/2026</span>
            ...
            <div class="topbar-actions">
                ...
                <div class="user-profile">
                    ...
                    {{ strtoupper(substr(auth()->user()->name ?? 'staff', 0, 1)) }}

                    </div>
                    <span class="user-profile-text">{{ auth()->user()->name ?? 'staff User' }}</span>
