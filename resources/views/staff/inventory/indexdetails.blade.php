...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3>Projects (Inventory/Daily Book)</h3>
</div>
...
<div class="tabs-wrapper">
    <div class="tabs">
        <button class="tab active" onclick="switchTab('tab-active', this)">Inventory</button>
        <button class="tab" onclick="switchTab('tab-returned', this)">Daily Book</button>
    ...
    <div class="tab-content">
        ...
        <div class="content2 emd tab-active">
            @include('staff.inventory.index')
        </div>

        <div class="content2 emd tab-returned">
            @include('staff.daily_notes.index')
        </div>
