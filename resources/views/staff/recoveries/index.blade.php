    ...
    <div class="col-md-12 mb-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    {{-- <form action="{{ route('staff.billing.items.store', $bill) }}" method="POST" class="row g-2 mb-3">
                        @csrf
                        <div class="col-md-2">
                        ...
                        <tbody>
                            @foreach($bill->items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('staff.billing.items.destroy', $item) }}" method="POST"
                    ...
                    <form action="{{ route('staff.billing.recovery.store', $billing) }}"
                     method="POST">
                        @csrf
                        <div class="row g-2">
                            @php
        ...
        <tbody>
            @forelse($recoveries as $p)
                <tr>
                    ...
                    <td>{{ $p->total }}</td>
                    <td>
                        <a href="{{ route('staff.security-deposits.create', [
                            'project' => $project->id,
                            'billing' => $billing->id,
